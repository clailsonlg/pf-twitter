defmodule Pfu.Accounts do
  ...
  alias Pfu.Repo
  alias Pfu.{User, UserToken, UserNotifier}
  ...
  defp user_username_multi(user, username, context) do
    changeset = user |> User.email_changeset(%{username: username}) |> User.confirm_changeset()
  ...
  """
  def deliver_update_username_instructions(%User{} = user, current_username, update_username_url_fun)
